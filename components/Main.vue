        ...
        <div class="rank-stats">
          <div class="rank-champ">
            <div :key="index" v-bind="masteries" v-for="(champs, index) of masteries">
              <div class="rank-icon">
                <img
                  :src="'https://cdn.communitydragon.org/9.23.1/champion/'+champs.championId+'/square' "
                  alt
                >
          ...
          >
            ...
            <div class="match-summary">
              <div class="match-champ-stats">
                <img
                  class="match-champ"
                  :src="'https://cdn.communitydragon.org/9.23.1/champion/'+matchlist[index].participants[player].championId+'/square'"
                  alt
                >
                <p>
            ...
            <div class="match-summary">
              <div class="match-summoners">
                <img
                  ...
                  :src="'http://ddragon.leagueoflegends.com/cdn/9.23.1/img/spell/'+summonername[matchlist[index].participants[player].spell1Id]+'.png'"
                  alt
                >
                <img
                  class="match-summoner-icon"
                  :src="'http://ddragon.leagueoflegends.com/cdn/9.23.1/img/spell/'+summonername[matchlist[index].participants[player].spell2Id]+'.png'"
                  alt
                >
                <img
                  class="match-summoner-icon"
                  :src="'http://ddragon.leagueoflegends.com/cdn/9.23.1/img/item/'+matchlist[index].participants[player].stats.item6+'.png'"
                  alt
                >
              </div>
            </div>
            ...
            <div class="match-summary">
              <div class="match-items">
                <img
                  :src="'http://ddragon.leagueoflegends.com/cdn/9.23.1/img/item/'+matchlist[index].participants[player].stats.item0+'.png'"
                  alt
                >
                <img
                  :src="'http://ddragon.leagueoflegends.com/cdn/9.23.1/img/item/'+matchlist[index].participants[player].stats.item1+'.png'"
                  alt
                >
                <img
                  :src="'http://ddragon.leagueoflegends.com/cdn/9.23.1/img/item/'+matchlist[index].participants[player].stats.item2+'.png'"
                  alt
                >
                <img
                  :src="'http://ddragon.leagueoflegends.com/cdn/9.23.1/img/item/'+matchlist[index].participants[player].stats.item3+'.png'"
                  alt
                >
                <img
                  :src="'http://ddragon.leagueoflegends.com/cdn/9.23.1/img/item/'+matchlist[index].participants[player].stats.item4+'.png'"
                  alt
                >
                <img
                  :src="'http://ddragon.leagueoflegends.com/cdn/9.23.1/img/item/'+matchlist[index].participants[player].stats.item5+'.png'"
                  alt
                >
              </div>
            </div>
          ...
          >
            ...
            >
              <div class="champ-level">
                <img
                  :src="'https://cdn.communitydragon.org/9.23.1/champion/'+matchlist[index].participants[id].championId+'/square'"
                  alt
                  class="match-champs"
                >
              ...
              <div class="match-summoners">
                <img
                  ...
                  :src="'http://ddragon.leagueoflegends.com/cdn/9.23.1/img/spell/'+summonername[matchlist[index].participants[id].spell1Id]+'.png'"
                  alt
                >
                <img
                  class="match-team-icon"
                  :src="'http://ddragon.leagueoflegends.com/cdn/9.23.1/img/spell/'+summonername[matchlist[index].participants[id].spell2Id]+'.png'"
                  alt
                >
                <img
                  class="match-team-icon"
                  :src="'http://ddragon.leagueoflegends.com/cdn/9.23.1/img/item/'+matchlist[index].participants[id].stats.item6+'.png'"
                  alt
                >
              </div>
              <div class="match-summoners">
              ...
              <div class="team-items">
                <img
                  :src="'http://ddragon.leagueoflegends.com/cdn/9.23.1/img/item/'+matchlist[index].participants[id].stats.item0+'.png'"
                  alt
                >
                <img
                  :src="'http://ddragon.leagueoflegends.com/cdn/9.23.1/img/item/'+matchlist[index].participants[id].stats.item1+'.png'"
                  alt
                >
                <img
                  :src="'http://ddragon.leagueoflegends.com/cdn/9.23.1/img/item/'+matchlist[index].participants[id].stats.item2+'.png'"
                  alt
                >
                <img
                  :src="'http://ddragon.leagueoflegends.com/cdn/9.23.1/img/item/'+matchlist[index].participants[id].stats.item3+'.png'"
                  alt
                >
                <img
                  :src="'http://ddragon.leagueoflegends.com/cdn/9.23.1/img/item/'+matchlist[index].participants[id].stats.item4+'.png'"
                  alt
                >
                <img
                  :src="'http://ddragon.leagueoflegends.com/cdn/9.23.1/img/item/'+matchlist[index].participants[id].stats.item5+'.png'"
                  alt
                >
              </div>
            </div>
